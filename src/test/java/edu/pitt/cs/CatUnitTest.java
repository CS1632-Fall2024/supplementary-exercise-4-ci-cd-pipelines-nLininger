...
public class CatUnitTest {
	...
	public void testGetRented() {
		...
		boolean is_rented = c.getRented();
		assertFalse(is_rented);
	}
	...
	public void testToString() {
		...
		String cat_info = c.toString();
		assertEquals("ID 1. Jennyanydots", cat_info);
	}
	...
	public void testRenameCat() {
		...
		assertEquals("Garfield", cat_name);
		assertEquals("ID 1. Garfield", cat_info);
	}
